...
function void sm_sample(int hart, int issue, ins_t ins);
    ...
    //$display("Sm_sample: PC = %h (%0d) misa %b rs1 %b, misa_c0 %b, pc_1 %b",
    //    ins.current.pc_rdata, ins.current.inst_id, ins.current.insn[31:20] == CSR_MISA, ins.current.rs1_val[25:0],
